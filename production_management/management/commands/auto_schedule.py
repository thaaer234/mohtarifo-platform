...
EXAM_SCHEDULE = {
    ...
    ('ninth', 'اللغة الانكليزية'): {'date': date(2026, 6, 7), 'time': time(8, 30), 'duration': '1:30'},
    ...
    ('ninth', 'اللغة الفرنسية'): {'date': date(2026, 6, 17), 'time': time(8, 30), 'duration': '1:30'},
    ...
    ('ninth', 'التربية الاسلامية'): {'date': date(2026, 6, 20), 'time': time(8, 30), 'duration': '1:30'},
    ('ninth', 'اسلامية'): {'date': date(2026, 6, 20), 'time': time(8, 30), 'duration': '1:30'},
    ('ninth', 'العربية'): {'date': date(2026, 6, 24), 'time': time(8, 30), 'duration': '2:30'},
    ('ninth', 'اللغة العربية'): {'date': date(2026, 6, 24), 'time': time(8, 30), 'duration': '2:30'},
    ...
    ('science', 'اللغة الانكليزية'): {'date': date(2026, 6, 9), 'time': time(8, 30), 'duration': '2'},
    ...
    ('science', 'علم الأحياء'): {'date': date(2026, 6, 16), 'time': time(8, 30), 'duration': '2:30'},
    ('science', 'الفرنسية'): {'date': date(2026, 6, 18), 'time': time(8, 30), 'duration': '2'},
    ('science', 'اللغة الفرنسية'): {'date': date(2026, 6, 18), 'time': time(8, 30), 'duration': '2'},
    ('science', 'الديانة'): {'date': date(2026, 6, 21), 'time': time(8, 30), 'duration': '1:30'},
    ('science', 'التربية الاسلامية'): {'date': date(2026, 6, 21), 'time': time(8, 30), 'duration': '1:30'},
    ('science', 'العربية'): {'date': date(2026, 6, 25), 'time': time(8, 30), 'duration': '2:30'},
    ('science', 'اللغة العربية'): {'date': date(2026, 6, 25), 'time': time(8, 30), 'duration': '2:30'},
    ...
    ('literal', 'اللغة الانكليزية'): {'date': date(2026, 6, 9), 'time': time(8, 30), 'duration': '2:30'},
    ...
    ('literal', 'اللغة الفرنسية'): {'date': date(2026, 6, 18), 'time': time(8, 30), 'duration': '2:30'},
    ('literal', 'الديانة'): {'date': date(2026, 6, 21), 'time': time(8, 30), 'duration': '1:30'},
    ('literal', 'التربية الاسلامية'): {'date': date(2026, 6, 21), 'time': time(8, 30), 'duration': '1:30'},
    ('literal', 'العربية'): {'date': date(2026, 6, 25), 'time': time(8, 30), 'duration': '2:30'},
    ('literal', 'اللغة العربية'): {'date': date(2026, 6, 25), 'time': time(8, 30), 'duration': '2:30'},
}
