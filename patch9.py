...
replacement = '''            # ── ULTIMATE FAIL-SAFE & BULLETPROOF WRAPPER ──
            try:
                num_days = 1
...
# Performing the surgery replacement from lines index 258 to 346
new_lines = lines[:258] + [replacement + "\n"] + lines[346:]

with open(filepath, 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("The Indestructible Ultimate Fail-Safe Generation Engine is Active!")
